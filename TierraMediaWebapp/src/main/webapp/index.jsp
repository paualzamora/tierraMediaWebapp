	...
	<div class="container">
		...
		<script>
			function typewriter(palabras, colores) {
				...
				window.setInterval(function() { //wait between words when it starts writting
					if (letters_count === 0 && wait === false) {
						...
						text.innerHTML = palabras[0].substr(0, letters_count)
						letters_count += temp;
					}
				}, 120)
			...
			typewriter([ 'Aventuras', 'Paisajes', 'Sabores',
					'Experiencias únicas' ], [ '#FFFFFF', '#FFFFFF', '#FFFFFF',
					'#FFFFFF' ]);
		</script>
	</div>
	<main>
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						...
						<div class="carousel-caption d-none d-md-block">
							<h3>Moria</h3>
							<p>Tipo de atracción: Aventura / Costo: 10 monedas / Tiempo:
								2 horas</p>
						</div>
					</div>
					...
					<div class="carousel-item">
						...
						<div class="carousel-caption d-none d-md-block">
							<h3>Mordor</h3>
							<p>Tipo de atracción: Aventura / Costo: 25 monedas / Tiempo:
								3 horas</p>
						</div>
					</div>
					<div class="carousel-item">
						...
						<div class="carousel-caption d-none d-md-block">
							...
							<p>Tipo de atracción: Paisaje / Costo: 5 monedas / Tiempo: 2
								horas</p>
						</div>
					</div>
					<div class="carousel-item">
					...
					<div class="carousel-item">
						...
						<div class="carousel-caption d-none d-md-block">
							<h3>Erebor</h3>
							<p>Tipo de atracción: Paisaje / Costo: 12 monedas / Tiempo: 3
								horas</p>
						</div>
					</div>
					<div class="carousel-item">
						...
						<div class="carousel-caption d-none d-md-block">
							<h3>Bosque Negro</h3>
							<p>Tipo de atracción: Aventura / Costo: 3 monedas / Tiempo: 4
								horas</p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div id="controlesPromos">
					<a class="btn btn-outline-dark mb-3 mr-1"
						...
						class="fa fa-arrow-left"></i></a> <a class="btn btn-outline-dark mb-3"
