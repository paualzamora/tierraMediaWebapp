			...
			<form action="/TierraMediaWebapp/views/createUsuario.do"
				...
				<div class="mb-3">
					<label for="presupuesto" class="form-label">Presupuesto</label> <input
						...
						id="presupuesto" value="${tmp_usuario.presupuesto}">
				</div>
				<div class="mb-3">
					<label for="tiempoDisponible" class="form-label">Tiempo disponible</label> <input
						...
						id="tiempoDisponible" value="${tmp_usuario.tiempoDisponible}">
				</div>
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" id="admin" value="${tmp_usuario.admin}">
